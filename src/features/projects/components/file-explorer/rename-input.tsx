...
export const RenameInput = ({
  ...
  { type: 'file' | 'folder'; defaultValue: string; isOpen?: boolean; level: number; onSubmit: (name: string) => void; onCancel: () => void }) => {
  ...
  return (
    ...
    >
      ...
      <input
        ...
        autoFocus type="text" placeholder="Name" value={value} onChange={(e) => setValue(e.target.value)}
        onBlur={handleSubmit}
        onKeyDown={(e) => {
          if (e.key === 'Enter') {
            handleSubmit();
